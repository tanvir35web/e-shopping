...
const Footer = () => {
    return (
        <div className="bg-gray-950 text-gray-300 py-20 font-bodyFont">
            <div className="max-w-screen-xl w-4/5 mx-auto grid grid-row-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-2 text-base">
                        <p>B-10, KBS, Kallyanpur, Dhaka</p>
                        <p>Phone: +880 1625568609</p>
                        <p>Email: tanvir.niter09@gmail.com</p>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className="mt-10">
                        Happiness is not money, but shopping. Thanks
                    </p>
                </div>
            </div>
        </div>
